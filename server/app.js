...
async function getAnswers() {
  try {
    ...
    const [annotateImageResponse] = await client.annotateImage({
      image: {
        source: {
          imageUri: 'https://www.thesprucepets.com/thmb/WCHi1vABy_vfH6kDo7snIluUzyo=/2109x0/filters:no_upscale():strip_icc()/GettyImages-909948608-5c69cd9446e0fb0001560d1a.jpg',
        },
      },
